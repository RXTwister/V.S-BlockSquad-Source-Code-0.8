...
{
	public static var vsBlocksquad:String = 'Private Beta 1.6'; //This is also used for Discord RPC
	...
	override function create()
	{
        ...
        var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "V.S BlockSquad " + vsBlocksquad, 12);
